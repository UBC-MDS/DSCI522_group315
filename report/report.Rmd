...
```{r pair-wise, echo=FALSE, fig.cap="Figure 1. Correlation matrix for features and target.", out.width = '65%', fig.align="center"}
...
```{r strike, echo=FALSE, fig.cap="Figure 2. Comparison of the distributions of the predictors between winning and losing in different groups. Top left: striking features, top right: ground features, bottom left: attacks-to features, bottom right: attacks-from features.The feature explanations can be found in method section.", out.width = '40%',out.width = '50%', fig.show='hold'}
